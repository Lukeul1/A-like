...
// Randomly select a target word and its synonyms from the word list
const wordList = [
  { word: 'tree', synonyms: ['plant', 'flora', 'wood'] },
  { word: 'pineapple', synonyms: ['fruit', 'tropical', 'spiky'] },
  { word: 'bird', synonyms: ['avian', 'feathered', 'fly'] },
  { word: 'pizza', synonyms: ['food', 'cheese', 'dough'] }
]; // Replace with your word list

const randomIndex = Math.floor(Math.random() * wordList.length);
const targetWordObj = wordList[randomIndex];
const targetWord = targetWordObj.word;
const synonyms = targetWordObj.synonyms;
